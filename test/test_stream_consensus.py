...
@pytest.mark.parametrize("folder,consensus_file,percent,count", [
    ("tracks_for_consensus", "consensus_weak/consensus_weak_zinbra_consensus.bed", False, 2),
    ("tracks_for_consensus", "consensus_median/consensus_median_zinbra_consensus.bed", 50, False),
    ("tracks_for_consensus", "consensus_strong/consensus_strong_zinbra_consensus.bed", 100, False)
])
def test_stream_consensus(capfd, test_data, folder, consensus_file, percent, count):
    files = []
